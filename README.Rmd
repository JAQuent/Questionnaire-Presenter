...
For the most part the way to analyse the response should be fairly obvious. The only tricky bit might be to analyse radio & checkmark questions. Here is short demonstration to do this. 
