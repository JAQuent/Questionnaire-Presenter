...
- [Example input files](#Example-input-files)
  ...
  - [Further input through session .json file](#Further-input-through session-.json-file)
  - [Customisation of the UXF Startup panel using a .json file](#Customisation-of-the-UXF-Startup-panel-using-a-.json-file)
